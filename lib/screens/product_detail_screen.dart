...
class _ProductDetailScreenState extends State<ProductDetailScreen> {  
  ...
  Widget build(BuildContext context) {  
    return Scaffold(  
      appBar: AppBar(  
        title: const Text('Detail Produk', style: TextStyle(fontFamily: 'DynaPuff')), // DynaPuff font  
      ),  
      body: Container(  
                ...
                children: [  
                  ...
                  Text(  
                    ...
                    style: const TextStyle(  
                      ...
                      fontFamily: 'DynaPuff', // DynaPuff font  
                    ),  
                  ),  
                  ...
                  Row(  
                    children: [  
                      ...
                      Text(  
                        ' $_quantity', // Menampilkan jumlah saat ini  
                        style: const TextStyle(fontSize: 20, fontFamily: 'DynaPuff'), // DynaPuff font  
                      ),  
                      IconButton(  
                  ...
                  ElevatedButton(  
                    ...
                    child: const Text('Tambah ke Keranjang', style: TextStyle(fontFamily: 'DynaPuff')), // DynaPuff font  
                  ),  
                ],  
              );  
            }  
